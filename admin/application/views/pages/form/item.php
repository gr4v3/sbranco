 ...
 */
?>
<form target="pages-form-target" action="http://sandrabranco.com/admin/pages/index/<?php echo $link; ?>?type=ajax" enctype="multipart/form-data" method="post" accept-charset="utf-8">
